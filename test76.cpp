#include<stdlib.h> //malloc, srand, rand, abort, atoi, getenv
...
int main(int argc, char *argv[]){
	...
	char *str=(char *)malloc(sizeof(char)*strlen(env)+sizeof(char)*strlen(argv[1])+1);
	strcpy(str, "PATH="); //something bad happens when i dont initialize with strcpy
	strcat(str, env);
	strcat(str, ";");
	strcat(str, argv[1]);
	//printf("%s\n", str);
